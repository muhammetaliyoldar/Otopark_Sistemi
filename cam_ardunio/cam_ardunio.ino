...
// AI-THINKER ESP32-CAM pin konfigürasyonu
...
static esp_err_t stream_handler(httpd_req_t *req) {
    ...
    while (true) {
        ...
        if (!fb) {
            Serial.println("Frame alma hatası");
            res = ESP_FAIL;
        } else {
...
void startCameraServer() {
    ...
    if (httpd_start(&stream_httpd, &config) == ESP_OK) {
        ...
        Serial.println("Stream server başlatıldı");
    }
}
...
void setup() {
    ...
    Serial.print("Kameraya şu adresten erişebilirsiniz: http://");
